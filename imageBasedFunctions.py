...
def titleScreen():
    ...
    printSlow("      _____        _____                   ",
              0.05, True, 0, PADDINGNONE)
    console.set_cursor_pos(35, console_info.window_rectangle.bottom - 1)
    printSlow("  ___|\    \   ___|\    \  _____      _____",
              0.05, True, 0, PADDINGNONE)
    console.set_cursor_pos(35, console_info.window_rectangle.bottom - 1)
    printSlow(" /    /\    \ |    |\    \ \    \    /    /",
              0.05, True, 0, PADDINGNONE)
    ...
    printSlow("|    |  |    ||    | |    | /    /  \    \ ",
              0.05, True, 0, PADDINGNONE)
    console.set_cursor_pos(35, console_info.window_rectangle.bottom - 1)
    printSlow("|____|  |____||____| |____|/____/ /\ \____\ ",
              0.05, True, 0, PADDINGNONE)
    console.set_cursor_pos(35, console_info.window_rectangle.bottom - 1)
    printSlow("|    |  |    ||    | |    ||    |/  \|    |",
              0.05, True, 0, PADDINGNONE)
    ...
    printSlow(
        "A text based adventure game made by Vladimir with help from friends.", 0.05, True, 0, PADDINGNONE)
    console.set_cursor_pos(29, console_info.window_rectangle.bottom - 1)
    printSlow(
        "- Inspired by Choose Your Own Adventure Books and D&D -", 0.05, True, 0, PADDINGNONE)
    for row in range(8):
        t.sleep(0.05)
